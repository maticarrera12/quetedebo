...
export const CalculatePage = (props: Props) => {
  ...
  <form className="space-y-4">
    ...
    <div className="flex gap-4">
      <CustomButton
        onClick={() => addFriend(name, expense)}
        text="Agregar"
        className="w-1/2"
      />
      <CustomButton onClick={reset} text="Borrar" className="w-1/2 bg-red-500 hover:bg-red-600" />
    </div>
    ...
    <div className="space-y-2">
      ...
      <p className="text-lg font-semibold text-gray-700">
        Total: ${friends.reduce((total, friend) => total + friend.expense, 0)}
      </p>
